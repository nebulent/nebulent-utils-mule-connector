...
import com.nebulent.mule.utils.processors.ThrottleMessageProcessor;
...
public class ThrottleDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public ThrottleDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ThrottleMessageProcessor.class.getName());
